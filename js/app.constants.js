(function(){
  ...
  angular.module('app').constant('imp', {
    uids: ['9IRIeiwCixN8j9fCS6hvlcAhLeu2',
    ...
    'Ey0M1x2q4jWrgDtvZeLRtIeG43r2','vWTymDmMk8NZKY6sg7KB75L3tyg1','pDKDvcwsKIP8EfIQrapUE1pidIk2','VmTaFDUnvLWeKBfRWv52y9idoAy2','dfDVfDJnBYNndELAPzaXSvvHR363'],
    isUpper: (uid, uids) => {
      // console.log("uid: " + uid);
      if(!uid) {
        return false;
